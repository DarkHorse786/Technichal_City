...
public class remove_updateDevice extends JPanel {
    ...
    public remove_updateDevice() {
        ...
        JLabel lblInfo = new JLabel("* Enter all Details to REMOVE a Device:");
        ...
        JLabel lblRam = new JLabel("Storage Size");
        ...
        JLabel lblStorage = new JLabel("Size of Ram:");
            ...
            try 
            {
              ...
              for (int i = 0; i <= deviceList.size(); i++) 
              {
                ...
                if (deviceData[0].equals(deviceName)) {
                  ...
                  txtPicAdd.setText(deviceData[6]); 
                  deviceFound = true;
                  break;
                }
              }
